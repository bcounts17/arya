...
case $Version in
	...
	wget --quiet https://github.com/Dreyannz/VPS_Site/blob/master/Version%203.0/index.php
	wget --quiet https://github.com/Dreyannz/VPS_Site/blob/master/Version%203.0/server.php
